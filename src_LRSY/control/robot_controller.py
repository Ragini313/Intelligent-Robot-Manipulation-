...
class RobotMover(object):
    ...
    def is_in_ready_pose(self) -> bool:
        return True if self.arm_group.get_current_joint_values() == self.ready_pose_joint_states else False
    ...
    def move_to_ready_pose(self):
        ...
        """
        success = self.arm_group.go(self.ready_pose_joint_states ,wait=True)
